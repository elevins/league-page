...
<div class="constitution">
    ...
    <p>1 IR (Player must be labeled as IR in Sleeper</p>
    ...
    <p>Trading is allowed. Trades will process according to Sleeper settings, commisioner with push thru trades if both parties agree unless an investigation for collusion.</p>
    ...
    <div class="subBlock">
        <p>Commisioner reserves the right to conduct investigations. Not liking a trade does not warrant a veto.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. See Sleeper settings.</p>
    ...
    <h3 bind:this={twoTwo}>2.2 Rookie Drafts (Dynasty Only)</h3>
    ...
    <p>See Sleeper (0.5 PPR + 0.5 PFD).</p>
    ...
    <p>https://support.sleeper.com/en/articles/4238872-can-i-set-tiebreakers</p>
    ...
    <p>League dues are set at {dues}$. Dues are collected by the commisioner at the end of the season.</p>
